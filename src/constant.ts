...
export const panResponse = {
  PanList: [
    {
      newIconUrl: 'https://www.littlemermaid.jp/common/img/icon/icon_new.svg',
      panImgUrl:
        'https://www.littlemermaid.jp/products/assets_c/2023/02/202303_FlemishMilkPie-thumb-470xauto-4912.jpg',
      releaseDate: '【3月15日発売】',
      title: 'フランダース風ミルクパイ',
      isDisplayLimitedIcon: true,
    },
